 ...
 * Responsibilities:
 * - Binds {@link AIOBookmark} data (title, URL, favicon, creation date) to list rows.
...
public class BookmarkAdapter extends BaseAdapter {
	...
	private final ArrayList<AIOBookmark> displayedBookmarks = new ArrayList<>();
	 ...
	 * @return the {@link AIOBookmark} at the specified position, or null if position is invalid.
	 */
	@Nullable
	@Override
	public AIOBookmark getItem(int position) {
	...
	public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
		...
		AIOBookmark bookmarkModel = getItem(position);
	...
	public void loadMoreBookmarks(@Nullable String searchTerms) {
		...
		ArrayList<AIOBookmark> fullList;
	...
	public interface OnBookmarkItemClick {
		 ...
		 */
		void onBookmarkClick(@NonNull AIOBookmark bookmarkModel);
	}
	...
	public interface OnBookmarkItemLongClick {
		 ...
		 */
		void onBookmarkLongClick(@NonNull AIOBookmark bookmarkModel,
