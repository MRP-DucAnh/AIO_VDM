...
/**
 * Adapter responsible for displaying a list of available [AIOVideoFormat] items
 ...
 * @param videoFormats List of all available [AIOVideoFormat] options.
...
open class VideoFormatAdapter(
	...
	private val videoFormats: List<AIOVideoFormat>,
	...
	/** @return The [AIOVideoFormat] object at the specified list position */
	override fun getItem(position: Int): AIOVideoFormat = videoFormats[position]
	 ...
	 *
	 * @return The selected [AIOVideoFormat], or null if no format is currently selected.
	 */
	fun getSelectedFormat(): AIOVideoFormat? {
